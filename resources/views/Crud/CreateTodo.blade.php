...
@section('content')
  ...
  <form action="" class="block bg-gray-200 p-3 mx-3  mx-50 shadow-lg rounded-xl ">
        <div class="mb-4">
         <label for="title" class="m-2 text-lg text-black block">Title</label>
        <input type="text" name="title" id="title"
        class="rounded-lg p-2 w-100 bg-white shadow-lg ">
        </div>

        <div class="mb-4">
         <label for="title"  class="m-2 text-lg text-black" >Description</label>
         <textarea name="description" id="description"
          cols="10" rows="10"   class="rounded-lg p-2 w-100 bg-white shadow-lg
          resize-X w-full h-32"></textarea>
        </div>
